...
impl SovereignConfig {
    pub fn default_for_node(node_id: u64) -> Self {
        Self {
            ...
            peers: vec![
                PeerInfo { id: 1, host: "127.0.0.1".to_string(), http_port: 8001, raft_port: 9001 },
                PeerInfo { id: 2, host: "127.0.0.1".to_string(), http_port: 8002, raft_port: 9002 },
                PeerInfo { id: 3, host: "127.0.0.1".to_string(), http_port: 8003, raft_port: 9003 },
            ],
