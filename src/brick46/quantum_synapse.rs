...
//! Quantum-classical fusion Ã¢â‚¬â€ superpositional state mapping with bounded cache
...
impl QuantumSynapse {
    ...
    fn compute_amplitudes(&mut self, key: &QStateKey) -> Vec<f64> {
        ...
        for i in 0..key.dimension {
            let pseudo_random = ((seed.wrapping_add(i as u64 * 6364136223846793005) >> 16) as f64)
                / u16::MAX as f64;
